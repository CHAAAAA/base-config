			...
			<div class="col-lg-12">
				...
				<ui:table class="table-bordered table-hover data-box">
					...
					<ui:tr> 
						...
						<g:sortableColumn property="configType" title="${message(code: 'baseConfigProperty.configType.label', default: 'Config Type')}" /> 
						...
						<g:sortableColumn property="description" title="${message(code: 'baseConfigProperty.description.label', default: 'Description')}" /> 
					...
					<g:each in="${baseConfigPropertyInstanceList}" status="i" var="baseConfigPropertyInstance">
						<ui:tr> 
							...
							<td><f:display bean="${baseConfigPropertyInstance}" property="configType" /></td> 
							<td><f:display bean="${baseConfigPropertyInstance}" property="customKey" /></td> 
							<td><f:display bean="${baseConfigPropertyInstance}" property="customValue" /></td> 
							<td><f:display bean="${baseConfigPropertyInstance}" property="description" /></td> 
							<td>
